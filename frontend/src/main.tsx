...
function App() {
  ...
  return <div className="app-shell">
    ...
    <main className="workspace"><section className="board">
      ...
      {view==='board'?<>
        <div className="grid-summary"><span>{profile.rows} rows × {profile.columns} columns · {profile.playback_mode==='overlap'?'Sounds can overlap':'One sound at a time'}</span><span>Drag to swap · headphones to preview · pencil to configure</span></div>
